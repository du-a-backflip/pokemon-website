...
Danny = ((templatePage.replace('_IMG_', '<img src="GDPDannyData.png">')).replace('_HEADING', 'Standard Deviations').replace('_STATS_', f'<p>{Danny_Desc}</p>\n\t<ul class="meanul">\n{List[:-1]}\n\t</ul>')).replace('_NAVBAR_', navbar).replace('Data Table Page', 'Country SD')
...
David = ((templatePage.replace('_IMG_', '<img src="GDPDavidData.png">')).replace('_HEADING', 'Frequency of Percentages').replace('_STATS_', f'<p>{David_Desc}</p>')).replace('_NAVBAR_', navbar).replace('Data Table Page', 'Country Histogram')
