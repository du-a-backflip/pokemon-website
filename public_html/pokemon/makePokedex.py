    ...
    for i in range(len(data)):
        ...
        for j in range(len(data[i])):
            ...
            if i >= 1 and j == 0:
                ...
                tbody += '\n' + tab*6 + data[i][j]
                tbody += '\n' + tab*6 + '<br>'
                tbody += '\n' + tab*6 + '<img src ="../img/front/' + str(data[i][j]) + '.png">'
                tbody += '\n' + tab*6 + '<img src ="../img/back/' + str(data[i][j]) + '.png">'
                tbody += '\n' + tab*5 + '</td>'
            else:
...
pagefiles = ['http://marge.stuy.edu/~dbaig50/pokemon/makePokedex.py', '', 'allpokemon.html', 'top10pokemon.html']
...
def generatepage(Title, heading, table, text, style):
    ...
    body = tab*2 + '<h1>' + "Dua's Pokemon Website: " + heading + '</h1>'
